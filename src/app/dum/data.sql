...
(2, 2),  -- alice has ROLE_USER
(3, 2),  -- bob has ROLE_USER
(4, 2),  -- carol has ROLE_USER
(5, 2),  -- david has ROLE_USER
(6, 2),  -- emma has ROLE_USER
(7, 2),  -- frank has ROLE_USER
(8, 2),  -- grace has ROLE_USER
(9, 2),  -- henry has ROLE_USER
(10, 2), -- isabel has ROLE_USER
(11, 2), -- jack has ROLE_USER
(12, 2), -- kate has ROLE_USER
(13, 2), -- liam has ROLE_USER
(14, 2), -- mia has ROLE_USER
(15, 2); -- noah has ROLE_USER
...
(2, 4, 1, 'SELL', 1930.00, 3, 'FILLED'),
(3, 6, 4, 'BUY', 5200.75, 2, 'PARTIALLY_FILLED'),
(4, 8, 2, 'BUY', 26.25, 50, 'FILLED'),
(5, 10, 6, 'BUY', 100.50, 25, 'OPEN'),
(6, 12, 5, 'SELL', 13050.00, 1, 'FILLED'),
(7, 14, 3, 'BUY', 2850.25, 4, 'PARTIALLY_FILLED'),
(8, 16, 1, 'SELL', 1928.75, 2, 'FILLED'),
...
(4, 8, 1, 2, 1928.75, 'SETTLED'),
(10, 16, 8, 8, 449.25, 'SETTLED'),
(12, 6, 4, 1, 5197.50, 'SETTLED'),
...
('TRADE_EXECUTED',
'{"trade_id": 2, "asset_id": 1, "quantity": 2, "price": 1928.75, "buyer_party": 4, "seller_party": 8}',
'e5f6789012345678901234567890123456789012345678901234abcdef01',
...
-- ===================================================================
-- 12. INSERT NOTIFICATIONS (System notifications)
-- ===================================================================
INSERT INTO AJ_NOTIFICATION (user_id, message, type, is_read, created_at) VALUES
(2, 'Welcome to the Tokenization Platform! Your account has been activated.', 'INFO', false, CURRENT_TIMESTAMP),
(2, 'Trade executed: Bought 3 Gold Tokens at $1927.75', 'SUCCESS', false, CURRENT_TIMESTAMP),
(3, 'Trade executed: Sold 3 Gold Tokens at $1930.00', 'SUCCESS', true, CURRENT_TIMESTAMP),
(4, 'Order partially filled: Real Estate Token purchase', 'WARNING', false, CURRENT_TIMESTAMP),
(5, 'Trade settlement completed for Trade #1', 'SUCCESS', true, CURRENT_TIMESTAMP),
(6, 'New asset available: Treasury Bond Token', 'INFO', false, CURRENT_TIMESTAMP),
(7, 'KYC verification required for advanced trading', 'WARNING', false, CURRENT_TIMESTAMP),
(8, 'Trade executed: Sold 2 Gold Tokens at $1928.75', 'SUCCESS', true, CURRENT_TIMESTAMP),
(9, 'Monthly portfolio summary available', 'INFO', false, CURRENT_TIMESTAMP),
(10, 'Trade executed: Bought 8 Equity Index Tokens', 'SUCCESS', true, CURRENT_TIMESTAMP),
(11, 'Order open: Treasury Bond Token purchase pending', 'INFO', false, CURRENT_TIMESTAMP),
(12, 'Trade executed: Sold 1 Art Collection Token', 'SUCCESS', false, CURRENT_TIMESTAMP),
(13, 'Order cancelled: Silver Token sale', 'WARNING', true, CURRENT_TIMESTAMP),
(14, 'System maintenance scheduled for 2024-10-05', 'INFO', false, CURRENT_TIMESTAMP),
(15, 'New trading limits applied to your account', 'INFO', false, CURRENT_TIMESTAMP);
